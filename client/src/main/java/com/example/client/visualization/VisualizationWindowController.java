...
public class VisualizationWindowController {
    ...
    private Map<Integer, String> ownershipMap; // Map of (city_id, client_name)
    private Set<City> cities;

    public VisualizationWindowController(Set<City> cities) {
        this.cities = cities;
    }
    ...
    private void cityClicked(double x, double y) {
        ...
        for (City city : cities) {
            ...
            double canvasY = (double) (canvas.getHeight() - city.getCoordinates().getY() )/ 1000 * canvas.getHeight();
    ...
    private Image getCityIcon() {
        return new Image(Objects.requireNonNull(getClass().getResource("/com/example/client/icons/thick_building.png")).toExternalForm());
    }
}
